...
//   }
  ...
  let JoinGame = ( e ) =>{
    ...
    alert( "JOIN Game the name is : " + props.getTheName());
    ...
    if( playerId ) {
      ...
      get_player_url = 'http://127.0.0.1:8080/wp-json/black-jack/v1/addplayer/?game_id=' + e.target.id  + '&player_name=' + props.getTheName();
    }
  ...
  return (
    <div className="bj-game-list">
      <div className="user-input">
        <p><label>Enter your player name </label><input onChange = { setName } type="text"></input><span className ="info">&#x1F6C8;</span></p>
      ...
      <div> <button onClick = { getGameList( getName() ) }> Find new games !! </button></div>
    </div>
  );
}
